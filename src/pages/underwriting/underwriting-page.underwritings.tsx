...
import Underwriting from "../../components/underwritings/underwriting/Underwriting";
...
const tabs = (() => {
  ...
  if (!businessId) {
    return { title: "All", content: <Underwriting businessId={null} /> };
  }

  const risk = risks.find(r => String(r.riskID) === String(businessId));
  if (risk) {
    return { title: risk.riskName, content: <Underwriting businessId={risk.riskID} /> };
  }

  if (businessId =="Package") {
    return { title: "Package", content: <Underwriting businessId={"Package"} /> };
  }
  ...
  return (
    <div className="max-w-[1200px] mx-auto mb-10">
      <div className="mb-5">
        <h1 className="text-2xl font-semibold text-[#111827] m-0">Underwriting</h1>
      </div>
...
export default UnderwritingsPage;
